    ...
    Example6() {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                StringBuilder selectedOption = new StringBuilder("Selected option: ");
                ...
                JOptionPane.showMessageDialog(jfrm, selectedOption.toString(), "Selected Option", JOptionPane.INFORMATION_MESSAGE);
            }
        });
